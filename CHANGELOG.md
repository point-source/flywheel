# [3.0.0-dev.1](https://github.com/point-source/flywheel/compare/v2.0.0...v3.0.0-dev.1) (2026-05-03)


* feat(config)!: add develop to main-line stream as prerelease channel ([#25](https://github.com/point-source/flywheel/issues/25)) ([2743ff9](https://github.com/point-source/flywheel/commit/2743ff989a3713f69b647484fea80e4c20db7159)), closes [#14](https://github.com/point-source/flywheel/issues/14) [#4](https://github.com/point-source/flywheel/issues/4) [#6](https://github.com/point-source/flywheel/issues/6) [#1](https://github.com/point-source/flywheel/issues/1) [#8](https://github.com/point-source/flywheel/issues/8) [#7](https://github.com/point-source/flywheel/issues/7) [#2](https://github.com/point-source/flywheel/issues/2) [#7](https://github.com/point-source/flywheel/issues/7) [#3](https://github.com/point-source/flywheel/issues/3) [#13](https://github.com/point-source/flywheel/issues/13) [#NN](https://github.com/point-source/flywheel/issues/NN) [#24](https://github.com/point-source/flywheel/issues/24) [#24](https://github.com/point-source/flywheel/issues/24)


### Features

* **scripts:** adopter setup DX cleanups ([#27](https://github.com/point-source/flywheel/issues/27)) ([26f64b0](https://github.com/point-source/flywheel/commit/26f64b082f9615a573314c709df7d559d10f7bbd))
...
fallback). Adds GitHubClient.mergePR + fakeGh wiring + 1 …
...
* feat(config): add develop as prerelease channel in main-line stream

Promotes the action repo from a single-branch (main-only) stream to a
develop → main stream. develop is now the dev prerelease channel
(cuts v*-dev.N tags); merging develop → main triggers the real
release. The back-merge step in flywheel-push.yml then replays the
chore(release) commit + tag back into develop automatically — fixing
